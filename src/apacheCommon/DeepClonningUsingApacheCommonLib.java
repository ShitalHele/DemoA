...
import apacheCommon.model.ClonableAddress;
import apacheCommon.model.Employee;

public class DeepClonningUsingApacheCommonLib {
	
	public static void main(String[] args) throws CloneNotSupportedException {
		ClonableAddress address=new ClonableAddress("Pune");
		Employee e1=new Employee(1, "Swapnil", address);
		Employee e2= org.apache.commons.lang3.SerializationUtils.clone(e1);
